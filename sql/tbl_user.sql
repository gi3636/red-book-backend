...
CREATE TABLE tbl_user(
    id VARCHAR(255) NOT NULL   COMMENT '用户;' ,
    username VARCHAR(255) NOT NULL   COMMENT '用户名' ,
    password VARCHAR(255) NOT NULL   COMMENT '密码' ,
    mobile VARCHAR(255) NOT NULL   COMMENT '手机号' ,
    nickname VARCHAR(255) NOT NULL   COMMENT '昵称;媒体号' ,
    no VARCHAR(255) NOT NULL   COMMENT '媒体号，唯一标识;类似头条号，抖音号，公众号，唯一标识，需要限制修改次数，比如终生1次，每年1次，每半年1次等，可以用于付费修改。' ,
